            ...
            <div class="box box-primary">
                ...
                <form role="form" runat="server" method="post" name="nueva_categoria" id="nueva_categoria">
                    <div class="box-body" runat="server">
                        ...
                        <div class="form-group" runat="server">
                            <label for="labelDestacado">Destacado</label> <label for="Requerido" style="color: red;">*</label>
                            <asp:DropDownList id="destacadoCat" name="destacadoCat" class="form-control"  runat="server">
                                    <asp:ListItem Selected="True" Value="1"> Si </asp:ListItem>
                                    <asp:ListItem Value="0"> No </asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        ...
                        <div class="box-footer" runat="server">
                            <asp:Button ID="buttonGenerarCategoria" Style="margin-top: 5%" class="btn btn-primary" type="submit" runat="server" Text="Generar" OnClientClick="return confirm('¿Seguro que desea generar esta Categoria?');" OnClick="buttonGenerarCategoria_Click"></asp:Button>
                        </div>
