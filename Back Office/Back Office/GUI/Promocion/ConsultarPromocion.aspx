<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="ConsultarPromocion.aspx.cs" Inherits="Back_Office.GUI.Promocion.ConsultarPromocion" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Subtitulo" runat="server">
   <ul class="">
            ...
            <li id="" class=""><a href="../Promocion/AgregarPromocion.aspx"> Crear Promocion Nueva</a></li>
    ...
    <div class="row" runat="server">
        <div class="col-md-12" runat="server">
            <div class="box box-primary" runat="server">
                <form role="form" runat="server" method="post" name="consulta_promociones" id="consulta_promociones">
