<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="ActivarPromocion.aspx.cs" Inherits="Back_Office.GUI.Promocion.ActivarPromocion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Titulo" runat="server">
    Gestión de Promocion
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="Breadcrumps" runat="server">
    ...
    <li><a href="#">Gestión de Promocion</a></li>
                ...
                <form role="form" name="agregar_usuario" id="agregar_usuario" method="post" runat="server">
                    <div class="box-body" runat="server">
                        ...
                        <div class="form-group" runat="server">
                            <label for="IdUsuario">Id del Producto</label>
